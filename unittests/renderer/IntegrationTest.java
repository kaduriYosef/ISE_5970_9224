...
public class IntegrationTest {
    ...
    private int countIntersectionSphere(Intersectable body) throws CloneNotSupportedException {
        ...
        for (Ray ray : listOfRays) {
            List<Point> temp = body.findIntersections(ray);
    ...
    void testIntegration() throws CloneNotSupportedException {
        ...
        Plane plane1 = new Plane(new Point(0, 0, -4), new Vector(0, 0, 1));
        ...
        Plane plane2 = new Plane(new Point(0, 0, -4), new Point(1, 0, -3.5), new Point(0, 1, -4));
        ...
        Plane plane3 = new Plane(new Point(0, 0, -4), new Point(1, 0, -1.5), new Point(0, 1, -4));
        ...
        // Group tests of construct rays and intersections with triangle:
